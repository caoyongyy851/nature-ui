  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="发布人id" prop="uid">
       ...
       <el-form-item label="玩场id" prop="pid">
        <el-input
    ...
    >
      ...
      <el-table-column label="玩场id" align="center" prop="pid" />
      <el-table-column label="图片组" align="center">
        <template slot-scope="scope">
          <el-image
            :src="baseUrl + scope.row.imgs"
            style="width: 50px; height: 50px"
            fit="cover"
          />
        </template>
      </el-table-column>
      <el-table-column label="描述" align="center" prop="detail" show-overflow-tooltip="true"/>
      <el-table-column label="浏览数" align="center" prop="views" />
      <el-table-column label="喜欢数" align="center" prop="likes" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="玩场id" prop="pid">
          <el-input v-model="form.pid" placeholder="请输入玩场id" />
        </el-form-item>
        <el-form-item label="图片组或视频" prop="imgs">
          <el-input v-model="form.imgs" placeholder="请输入图片组或视频" />
        </el-form-item>
        <el-form-item label="图片数或视频数" prop="imgsNum">
          <el-input v-model="form.imgsNum" placeholder="请输入图片数或视频数" />
        </el-form-item>
        ...
        <el-form-item label="喜欢数" prop="likes">
          <el-input v-model="form.likes" placeholder="请输入喜欢数" />
        </el-form-item>
  ...
  methods: {
    ...
    getList() {
      ...
      listCard(this.queryParams).then((response) => {
        this.cardList = response.rows.map((item, index) => {
          if (item.imgs) {
            item.imgs = item.imgs.split(",")[0];
          }
          return item;
        });
