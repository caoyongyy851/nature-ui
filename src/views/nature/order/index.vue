<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['nature:order:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['nature:order:export']"
          >导出</el-button
        >
      </el-col>
    ...
    >
      ...
      <el-table-column label="核销码" align="center" prop="code" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="修改时间" prop="payTime">
          <el-date-picker
            clearable
            size="small"
            style="width: 200px"
        ...
        <el-form-item label="用户优惠券" prop="userCouponId">
          <el-input
            v-model="form.userCouponId"
            placeholder="请输入用户优惠券"
          />
        </el-form-item>
        <el-form-item label="现金券" prop="userCash">
          <el-input v-model="form.userCash" placeholder="请输入现金券" />
        </el-form-item>
      </el-form>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="codeComfirm">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    codeComfirm() {
      auditCode(this.codeForm.id).then((response) => {
